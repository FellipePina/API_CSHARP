...
void PopularBancoDeDados(WebApplication app)
{
    ...
    if (!context.Funcionarios.Any())
    {
        ...
        {
            new() { Id = 1, Nome = "Fellipe", Idade = 32, Sexo = "Masculino", Cpf = "067607224-80", Email = "fellipe@gmail.com",
            ...
            new() { Id = 2, Nome = "Mariana", Idade = 28, Sexo = "Feminino", Cpf = "123456789-00", Email = "mariana.silva@gmail.com",
            ...
            new() { Id = 3, Nome = "Carlos", Idade = 35, Sexo = "Masculino", Cpf = "234567891-00", Email = "carlos.souza@gmail.com",
            ...
            new() { Id = 4, Nome = "Ana Paula", Idade = 31, Sexo = "Feminino", Cpf = "345678912-00", Email = "ana.paula@gmail.com",
            ...
            new() { Id = 5, Nome = "Ricardo", Idade = 42, Sexo = "Masculino", Cpf = "456789123-00", Email = "ricardo.lima@gmail.com",
            ...
            new() { Id = 6, Nome = "Maria", Idade = 28, Sexo = "Feminino", Cpf = "98765432100", Email = "maria@email.com",
            Celular = "98888-8888", Cargo = "Gerente", Setor = "RH", CargaHorariaSemanal = 40, Salario = 6000,
            EstadoCivil = "Casada", GastosPorMes = 3500 },

            new() { Id = 7, Nome = "Paulo Henrique", Idade = 29, Sexo = "Masculino", Cpf = "567890123-00", Email = "paulo.henrique@gmail.com",
            ...
            new() { Id = 8, Nome = "Fernanda Costa", Idade = 33, Sexo = "Feminino", Cpf = "678901234-00", Email = "fernanda.costa@gmail.com",
            ...
            new() { Id = 9, Nome = "Lucas Martins", Idade = 27, Sexo = "Masculino", Cpf = "789012345-00", Email = "lucas.martins@gmail.com",
            ...
            new() { Id = 10, Nome = "Juliana Souza", Idade = 30, Sexo = "Feminino", Cpf = "890123456-00", Email = "juliana.souza@gmail.com",
